...
<main>
	...
	<div class="margin-top first">
		...
		<table class="table">
			<tbody>
				...
				<tr>
					<th>첨부파일</th>
					<td class="text-align-left text-indent" colspan="3"><c:forTokens var="fileName"
	...
	<div class="margin-top text-align-center">
		<a class="btn-text btn-cancel" href="list">목록</a> <a class="btn-text btn-default"
			href="${n.id}/edit">수정</a> <a class="btn-text btn-default" href="${n.id}/del">삭제</a>
	</div>
