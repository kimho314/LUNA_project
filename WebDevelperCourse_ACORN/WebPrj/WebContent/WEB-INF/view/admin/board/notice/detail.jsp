				...
				<div class="margin-top first">
					...
					<table class="table">
						<tbody>
							...
							<tr>
								<th>첨부파일</th>
								<td class="text-align-left text-indent" colspan="3"><c:forTokens
										var="fileName" items="${n.files}" delims=",">
										<a href="/upload/notice/${fileName}" download>${fn:substringAfter(fileName, '\\')}</a>
									</c:forTokens></td>
							</tr>
							<tr class="content">
