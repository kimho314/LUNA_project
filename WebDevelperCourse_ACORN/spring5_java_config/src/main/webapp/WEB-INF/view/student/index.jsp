	...
	<div class="-list- vertical margin-top first padding-bottom">
		...
		<div class="-margin- top">
			<table class="table -border- top orange">
				<tr>
					<th colspan="2" class="-text- bold orange">내 수강 요약정보</th>
				</tr>
				<tr>
					<td class="-border- right -reset- line-height -padding-">
						<div>현재 수강중인 강좌</div>
						<div>
							<span class="-text- orange">1</span> 개
						</div>
						<div class="-margin- top">
							<a class="-text- underline" href="course/taking">내 강의장으로 가기</a>
						</div>
					</td>
					<td class="-border- -reset- line-height -padding-">
						<div>최근 1주일 1:1 문의 결과</div>
						<div>
							<span class="-text- orange">0</span> / 0
						</div>
						<div class="-margin- top">
							<a class="-text- underline" href="helpdesk/question">문의 게시판으로 가기</a>
						</div>
					</td>
				</tr>
				<!-- <tr>
		...
		<div class="-margin- top t40">
			<table class="table">
				<tr>
					<th colspan="2" class="-text- bold">내 자산 요약정보</th>
				</tr>
				<tr>
					<td class="-border- right -reset- line-height -padding-">
						<div class="margin-top">내 포인트</div>
						<div>
							<span class="-text- orange">20,800</span> P
						</div>
						<div class="-margin- top">
							<a class="-text- underline" href="payment/point">포인트 기록 보기</a>
						</div>
						<div class="-margin- top">
							(매일 로그인만 해도 포인트가 쑥쑥!)<br />&nbsp;
						</div>
					</td>
					...
					<td class="-reset- line-height -padding-">
						<div>쿠폰</div>
						<div>
							<span class="text-strong color-warning">0</span> / <span class="text-strong color-strong">5</span>
						</div>
						<div class="-margin- top">
							<a class="-text- underline" href="payment/coupon">쿠폰함 보기</a>
						</div>
						<div class="-margin- top">
							(뉴렉처 이벤트로 쌓이는 쿠폰)<br />&nbsp;
						</div>
