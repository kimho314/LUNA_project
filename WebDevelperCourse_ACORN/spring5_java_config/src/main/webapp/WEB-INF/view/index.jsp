        ...
        <div class="content-container">
            <section class="guide">
                ...
                <div class="margin-top">
                    <a href="customer/faq/1"><img src="/resource/images/customer/installInfo.png" /></a>
                </div>
                <!-- <div>
            2
            </div>
    ...
    <main id="course">
        <section class="content-container list list-horizontal list-course list-course-index">
            ...
            <ul>
                ...
                <li class="item-course normal event">
                    <div>
                        <a href="course/2"><img src="/resource/images/course/java.png" /></a>                        
                    </div>
                    <div>
                        <div>
        ...
        <div class="content-container">
            ...
            <ul class="-list- horizontal center -margin- bottom top b20">
                <li><a target="_blank" href="http://www.notepubs.com"><img src="/resource/images/notepubs.png" alt="노트펍스" /></a></li>
                <li><a target="_blank" href="http://www.namoolab.com"><img src="/resource/images/namoolab.png" alt="나무랩연구소" /></a></li>                
